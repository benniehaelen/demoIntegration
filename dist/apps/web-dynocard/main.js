            ...
            d3.csv("assets/dataset2.csv")
                ...
                for (var i = 0; i < dataView.length; i++) {
                    retDataView.dataPoints.push({
                        ...
                        eventId: +dataView[i][DataColumns.eventId],
                        cardHeaderId: +dataView[i][DataColumns.cardHeaderId],
                        epocDate: +dataView[i][DataColumns.epocDate],
                        cardType: dataView[i][DataColumns.cardType],
                        cardId: dataView[i][DataColumns.cardId],
                        position: dataView[i][DataColumns.position],
