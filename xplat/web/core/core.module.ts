...
import { throwIfAlreadyLoaded } from '@iot-edge-dynocard/utils';
import {
  CoreModule,
  PlatformLanguageToken,
  WindowPlatformService
} from '@iot-edge-dynocard/core';
...
export class DynocardCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: DynocardCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'DynocardCoreModule');
  }
}
